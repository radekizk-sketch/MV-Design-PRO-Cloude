...
- [docs/ui/RESULTS_TABLES_CONTRACT.md](./ui/RESULTS_TABLES_CONTRACT.md) — **Results Tables: porównania A/B/C/..., Min/Max views, zaawansowane filtrowanie, eksport CSV/Excel/PDF z kontekstem (CANONICAL)**
