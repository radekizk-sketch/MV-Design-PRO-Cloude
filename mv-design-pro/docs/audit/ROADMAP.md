...
|---|---|---|---|---|---|---|
| R01 (doc-only) | Audyt + indeks dokumentów + plan czyszczenia | `docs/audit/*`, `docs/DOCS_INDEX.md`, ujednolicenie PL w wybranych docs | Nowe raporty audytu, spójny indeks, plan cleanup | Niskie | Brak (doc-only) | `docs/audit/STATE_OF_PROJECT.md`, `docs/audit/ROADMAP.md`, `docs/audit/DOC_CLEANUP_PLAN.md`, `docs/DOCS_INDEX.md`, `docs/01-Core.md`, `docs/04-Application.md`, `docs/ui/sld_rules.md` |
