...
| Bus terminology (Bus ≠ Node) | `SYSTEM_SPEC.md` §2.2, §12 | Code uses `Node` terminology throughout | **FAIL** | `backend/src/network_model/core/node.py` | Add Bus alias or rename in next major refactor per PLANS Phase 2. |
