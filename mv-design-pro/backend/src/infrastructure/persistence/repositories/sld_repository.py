...
class SldRepository:
    ...
    def save(
        ...
        *,
        ...
        normalized = self._normalize_payload(payload, name=name, dirty_flag=dirty_flag)
        self._session.add(
            SldDiagramORM(
                id=sld_id,
    ...
    def update_payload(self, diagram_id: UUID, payload: dict, *, commit: bool = True) -> None:
        ...
        normalized = self._normalize_payload(
            payload, name=row.name, dirty_flag=payload.get("dirty_flag", row.dirty_flag)
        )
    ...
    def _normalize_payload(
        self, payload: dict, *, name: str, dirty_flag: bool | None = None
    ) -> dict:
