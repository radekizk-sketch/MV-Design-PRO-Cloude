...
\begin{itemize}
  ...
  \item Przypadek: Golden Case 2f\_z
  \item Wersja solvera: 1.0.0-test
  \item Miejsce zwarcia: B1
  \item Typ zwarcia: SC2FZ
...
\subsection{Krok 3: Sieć składowych dla zwarcia 2F–Z}
...
\textbf{Podstawienie:}
$$
Z_k = 0.5000 + j1.2000\,\text{Ω} + (0.6000 + j1.1000\,\text{Ω} \cdot 0.8000 + j2.4000\,\text{Ω}) / 1.4000 + j3.5000\,\text{Ω} = 0.8586 + j1.9606\,\text{Ω}
$$

\textbf{Wynik:}
\begin{center}
$$
Z_k = 0.8586 + j1.9606\,\text{Ω}
$$
\end{center}
...
\textbf{Podstawienie:}
$$
I_1 = 9.5263 / 0.8586 + j1.9606\,\text{Ω} = 1.7855 - j4.0770\,\text{kA}, \quad I_2 = -\frac{Z_0}{Z_2 + Z_0} I_1 = -1.3568 + j2.6610\,\text{kA}, \quad I_0 = -\frac{Z_2}{Z_2 + Z_0} I_1 = -0.4286 + j1.4160\,\text{kA}, \quad Z_2 + Z_0 = 1.4000 + j3.5000\,\text{Ω}
$$

\textbf{Wynik:}
\begin{center}
$$
I_1 = 1.7855 - j4.0770\,\text{kA}
$$
\end{center}
...
\textbf{Podstawienie:}
$$
I_a = I_0 + I_1 + I_2 = 0.0000 + j0.0000\,\text{kA}, \quad I_b = I_0 + a^2 I_1 + a I_2 = -6.4782 - j0.5974\,\text{kA}, \quad I_c = I_0 + a I_1 + a^2 I_2 = 5.1923 + j4.8453\,\text{kA}
$$

\textbf{Wynik:}
\begin{center}
$$
I_a = 0.0000 + j0.0000\,\text{kA}
$$
\end{center}
...
\textbf{Podstawienie:}
$$
I_k'' = \frac{1.1000 \cdot 15.0000}{|Z_k|} = \frac{16.5000}{2.1404} = 7.7090\,\text{kA}
$$
...
\textbf{Podstawienie:}
$$
\kappa = 1.02 + 0.98 \cdot e^{-3 \cdot 0.4379} = 1.02 + 0.98 \cdot 0.2688 = 1.2834
$$
...
\textbf{Podstawienie:}
$$
i_p = 1.2834 \cdot \sqrt{2} \cdot 7.7090 = 1.2834 \cdot 1.4142 \cdot 7.7090 = 13.9920\,\text{kA}
$$
...
\textbf{Podstawienie:}
$$
I_{dyn} = i_p = 13.9920\,\text{kA}
$$

\textbf{Wynik:}
\begin{center}
$$
I_{dyn} = 13.9920\,\text{kA}
$$
\end{center}
...
\textbf{Podstawienie:}
$$
I_{th} = 7.7090 \cdot \sqrt{1.0000 + 0.0000} = 7.7090 \cdot 1.0000 = 7.7090\,\text{kA}
$$
...
$$
  \item
$$
I_b = -6.4782 - j0.5974\,\text{kA}
$$
  \item
$$
I_c = 5.1923 + j4.8453\,\text{kA}
$$
  \item
$$
I_{dyn} = 13.9920\,\text{kA}
